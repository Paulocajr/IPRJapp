...
public class Login extends Activity  {
     ...
     public void onCreate(Bundle savedInstanceState) {
	     super.onCreate(savedInstanceState);
			...
			//declarando itens do XML
			final Button  Button = (Button) findViewById(R.id.button1);
			
			// NumberPicker com as opções de período
			...
			//valor máximo de período
			np.setMaxValue(10);
			//valor mínimo de período
		        np.setMinValue(1);
	        ...
	        check3.setOnClickListener(new View.OnClickListener() {
	                public void onClick(View v) {
	                    ...
	                    //verificando o status da checkbox
			...
			//definiindo URL que será passada ao médoto que fará o Download do Calendário acadêmico
			 String url = "http://www.uerj.br/comunidade/arquivos/ca"+year+"/ca"+year+".pdf";
			 WebView webView = (WebView) findViewById(R.id.webView1);
	                 webView.setWebViewClient(new WebViewClient());
	          

		         //definiindo URL que será passada ao médoto que fará o Download do Guia de ramais	
			 ...
			 WebView webView_2 = (WebView) findViewById(R.id.webView2);
	                ...
	                //webview que carrerá a página de download do arquivo PDF do Calendário
	               ...
	               webView.loadUrl(url);
	                ...
	                //webview que carrerá a página de download do arquivo PDF do Guia de Ramais
...
//Método que faz o download do arquivo a partir da URL passada
//Faz o download do Calendário Acadêmico
//Cria uma pasta no SD card para salvar os arquivos .pdf
...
//Método que faz o download do arquivo a partir da URL passada
//Faz o download do Guia de Ramais
//Cria uma pasta no SD card para salvar os arquivos .pdf    
